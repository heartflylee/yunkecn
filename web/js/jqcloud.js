		...
		var drawWordCloud = function() {
			...
			var hitTest = function(elem, other_elems) {
				...
				var overlapping = function(a, b) {
					if (Math.abs(options.size * a.offsetLeft + a.offsetWidth - options.size * b.offsetLeft - b.offsetWidth) < a.offsetWidth + b.offsetWidth) {
						if (Math.abs(options.size * a.offsetTop + a.offsetHeight - options.size * b.offsetTop - b.offsetHeight) < a.offsetHeight + b.offsetHeight) {
							return true;
						}
					}
					return false;
