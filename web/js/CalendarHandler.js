var CalendarHandler = {
				...
				showYearStart: 2009,
				tag: 0,
				initializea: function() {
					$calendarItem = this.CreateCalendarInit(0, 0, 0);
					$("#Container").append($calendarItem);
					$("#context").css("height", $("#CalendarMain").height() - 50 + "px");
					$("#center-1").css("height", $("#context").height() - 30 + "px");
					...
					var itemPaddintTop = 50;
					$(".item").css({
						"width": $(".week-1").width() / 7 + "px",
						"line-height": itemPaddintTop + "px",
						"height": itemPaddintTop + "px"
					});
					//					$(".currentItem>a").css("margin-left", ($(".item").width() - 25) / 2 + "px").css("margin-top", /*($(".item").height() - 25) / 2 + */ "0px");
				...
				CreateSelectYear: function(showYearStart) {
					...
					$("#selectYearDiv>div").css("width", ($("#center-1").width() - 4) / 4 + "px").css("line-height", ($("#center-1").height() - 4) / 3 + "px");
					$("#centerMain").animate({
						marginLeft: "0px"
					}, 300);
				},
				CreateSelectMonth: function() {
					...
					$("#selectMonthDiv>div").css("width", ($("#center-1").width() - 4) / 4 + "px").css("line-height", ($("#center-1").height() - 4) / 3 + "px");
					$("#centerMain").animate({
						marginLeft: -$("#center-1").width() * 2 + "px"
					}, 300);
				},
				...
				CreateCalendarInit: function(y, m, d) {
					...
					for(var i = 0; i < nowDaysNub; i++) {
						...
						if(i == (nowDay - 1)) {
							$dayItem.append("<div class=\"item nowitem currentItem\"><i class=\"\"></i><a>" + (i + 1) + "</a></div>");
						} else {
							$dayItem.append("<div class=\"item nowitem\"><i class=\"\"></i><a>" + (i + 1) + "</a></div>");
						}
					}
					//获取总共已经生成的天数
				...
				CSS: function() {
					...
					//					$(".currentItem>a").css("margin-left", ($(".item").width() - 25) / 2 + "px").css("margin-top", "0px");
				},
