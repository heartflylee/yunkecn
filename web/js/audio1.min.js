...
(function(t, i, e) {
	"use strict";
	"undefined" != typeof module && module.exports ? module.exports = e(i, t) : "function" == typeof define && define.amd ? define(function() {
		return e(i, t)
	}) : t[i] = e(i, t)
})(window, "Audio5js", function(t, i) {
	"use strict";
	...
	function s(t) {
		var i, e = {};
		for(i in t) e[i] = "object" == typeof t[i] ? s(t[i]) : t[i];
		return e
	}
	var n = i.ActiveXObject;
	e.prototype = Error();
	var a = function(t, i) {
			var e, n = s(i);
		...
		o = function(t, i) {
			return a(t.prototype, i)
		},
		r = {
			on: function(t, i, e) {
				this.subscribe(t, i, e, !1)
			},
			one: function(t, i, e) {
				this.subscribe(t, i, e, !0)
			},
			off: function(t, i) {
				if(void 0 !== this.channels[t]) {
					var e, s;
					for(e = 0, s = this.channels[t].length; s > e; e++) {
						var n = this.channels[t][e].fn;
						if(n === i) {
			...
			trigger: function(t) {
				if(this.channels && this.channels.hasOwnProperty(t)) {
					for(var i = Array.prototype.slice.call(arguments, 1), e = []; this.channels[t].length > 0;) {
						var s = this.channels[t].shift();
						"function" == typeof s.fn && s.fn.apply(s.ctx, i), s.once || e.push(s)
					}
					this.channels[t] = e
				}
			}
		...
		d = {
			flash_embed_code: function(i, e, s) {
				var a, o = '<param name="movie" value="' + e + "?playerInstance=window." + t + "_flash.instances['" + i + "']&datetime=" + s + '"/>' + '<param name="wmode" value="transparent"/>' + '<param name="allowscriptaccess" value="always" />' + "</object>";
				return a = n ? '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1" height="1" id="' + i + '">' : '<object type="application/x-shockwave-flash" data="' + e + "?playerInstance=window." + t + "_flash.instances['" + i + "']&datetime=" + s + '" width="1" height="1" id="' + i + '" >', a + o
			},
			can_play: function(t) {
				...
				switch(t) {
					case "mp3":
						...
						break;
					case "vorbis":
						i = 'audio/ogg; codecs="vorbis"';
						break;
					case "opus":
						i = 'audio/ogg; codecs="opus"';
						break;
					case "webm":
						i = 'audio/webm; codecs="vorbis"';
						break;
					case "mp4":
						i = 'audio/mp4; codecs="mp4a.40.5"';
						break;
					case "wav":
						i = 'audio/wav; codecs="1"'
				}
				return void 0 !== i ? "mp3" === t && navigator.userAgent.match(/Android/i) && navigator.userAgent.match(/Firefox/i) ? !0 : !!e.canPlayType && "" !== e.canPlayType(i) : !1
			},
			has_flash: function() {
				var t = !1;
				if(navigator.plugins && navigator.plugins.length && navigator.plugins["Shockwave Flash"]) t = !0;
					...
					var e = new n("ShockwaveFlash.ShockwaveFlash");
					t = "object" == typeof e
				} catch(s) {}
				return t
			}(),
			embedFlash: function(e, s) {
				var n = document.createElement("div");
				if(n.style.position = "absolute", n.style.width = "1px", n.style.height = "1px", n.style.top = "1px", document.body.appendChild(n), "object" == typeof i.swfobject) {
					var a = {
							playerInstance: "window." + t + "_flash.instances['" + s + "']"
						},
						o = {
							allowscriptaccess: "always",
							wmode: "transparent"
						};
					n.innerHTML = '<div id="' + s + '"></div>', swfobject.embedSWF(e + "?ts=" + ((new Date).getTime() + Math.random()), s, "1", "1", "9.0.0", null, a, o)
				} else {
					var r = (new Date).getTime() + Math.random();
					console.log(s);
					console.log(e);
					console.log(r);
					n.innerHTML = this.flash_embed_code(s, e, r)
				}
				return document.getElementById(s)
			},
			formatTime: function(t) {
				var i, e = parseInt(t / 3600, 10) % 24,
					s = parseInt(t / 60, 10) % 60,
					n = parseInt(t % 60, 10),
					a = (10 > s ? "0" + s : s) + ":" + (10 > n ? "0" + n : n);
				return i = e > 0 ? (10 > e ? "0" + e : e) + ":" + a : a
			}
		};
	d.use_flash = d.can_play("mp3");
	var h, u, l, c = {
			playing: !1,
			vol: 1,
			duration: 0,
		...
		f = i[t + "_flash"] = i[t + "_flash"] || {
			instances: {},
			count: 0
		};
	u = function() {
		if(d.use_flash && !d.has_flash) throw Error("Flash Plugin Missing")
	}, u.prototype = {
		init: function(i) {
			f.count += 1, this.id = t + f.count, f.instances[this.id] = this, this.embed(i)
		},
		embed: function(t) {
			d.embedFlash(t, this.id)
		},
		eiReady: function() {
		...
		eiTimeUpdate: function(t, i, e) {
//			console.log(t);
//			console.log(i);
//			console.log(e);
			this.position = t, this.duration = i, this.seekable = e, this.trigger("timeupdate", t, this.seekable ? i : null)
		},
		eiProgress: function(t, i, e) {
			this.load_percent = t, this.duration = i, this.seekable = e, this.trigger("progress", t)
		},
...
//			console.log(t);
		...
		destroyAudio: function() {
			this.audio && (this.pause(), this.audio.parentNode.removeChild(this.audio), delete f.instances[this.id], delete this.audio)
		}
	}, o(u, r), o(u, c), l = function() {}, l.prototype = {
		init: function() {
			this.trigger("ready")
		},
...
//			console.log(this.load_percent);
			if(this.audio && this.playing) {
				try {
					this.position = this.audio.currentTime, this.duration = 1 / 0 === this.audio.duration ? null : this.audio.duration
				} catch(t) {}
...
//console.log((this.audio.buffered.end(this.audio.buffered.length - 1) / this.duration));
			this.audio && null !== this.audio.buffered && this.audio.buffered.length && (this.duration = 1 / 0 === this.audio.duration ? null : this.audio.duration, this.load_percent = parseInt(100 * (this.audio.buffered.end(this.audio.buffered.length - 1) / this.duration), 10), this.load_percent >= 100 && this.clearLoadProgress())
		},
		onError: function(t) {
			this.trigger("error", t)
		},
...
//			console.log(this.load_percent);
		...
		load: function(t) {
			this.reset(), void 0 === this.audio && this.createAudio(), this.audio.setAttribute("src", t), this.audio.load()
		},
		play: function() {
			this.audio.play()
		},
		...
		volume: function(t) {
			...
			var i = 0 > t ? 0 : Math.min(1, t);
			this.audio.volume = i, this.vol = i
		},
		seek: function(t) {
			var i = this.playing;
			this.position = t, this.audio.currentTime = t, i ? this.play() : null !== this.audio.buffered && this.audio.buffered.length && this.trigger("timeupdate", this.position, this.duration)
		}
	}, o(l, r), o(l, c);
	var p = {
	...
	return h = function(t) {
		t = t || {};
		var i;
		for(i in p) p.hasOwnProperty(i) && !t.hasOwnProperty(i) && (t[i] = p[i]);
		this.init(t)
		...
		getPlayer: function() {
			var t, i, e, s;
			if(this.settings.use_flash) e = new u, this.settings.player = {
				engine: "flash",
				codec: "mp3"
			};
			else {
				for(t = 0, i = this.settings.codecs.length; i > t; t++)
					if(s = this.settings.codecs[t], h.can_play(s)) {
						e = new l, this.settings.use_flash = !1, this.settings.player = {
							engine: "html",
							codec: s
						};
						break
					}
				void 0 === e && (this.settings.use_flash = !h.can_play("mp3"), e = this.settings.use_flash ? new u : new l, this.settings.player = {
		...
		load: function(t) {
			var i = this,
				e = function(t) {
					i.audio.load(t), i.trigger("load")
				};
			this.ready ? e(t) : this.on("ready", e)
		},
		play: function() {
		...
		onError: function() {
			var t = new e("Audio Error. Failed to Load Audio");
//			console.log(t);
		...
		onTimeUpdate: function(t, i) {
			console.log(t);
			console.log(i);
			this.position = this.settings.format_time ? d.formatTime(t) : t, this.duration !== i && (this.duration = this.settings.format_time && null !== i ? d.formatTime(i) : i), this.trigger("timeupdate", this.position, this.duration)
		},
